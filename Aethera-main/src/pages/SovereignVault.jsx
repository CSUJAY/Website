...
import { Lock, Shield, Database, Key, Code, Clock } from 'lucide-react';
...
const SovereignVault = () => {
  const securityFeatures = [
    {
      ...
      description:
        'PII, Transcripts, and CRM data are encrypted end-to-end using the industry gold standard for confidentiality and integrity.',
    },
    {
      ...
      description:
        'Our server stack is hardened against common web exploits, ensuring the Aethera Work OS remains an impenetrable fortress.',
    },
    {
      ...
      description:
        'Your data lives in your isolated Sovereign Vault, preventing cross-tenant contamination and ensuring compliance.',
    },
    {
      ...
      description:
        'Designed from the ground up to meet stringent enterprise and regulatory compliance needs for sensitive meeting data.',
    },
    {
      ...
      description:
        'External Agents deploy with sophisticated anti-detection measures, maintaining the integrity and anonymity of your operation.',
    },
    {
      ...
      description:
        'The server provides exhaustive, color-coded logging for all actions and state changes, offering full visibility and swift disaster recovery.',
    },
  ];
  ...
  return (
    <div className="bg-white">
      <Helmet>
        <title>Aethera | Sovereign Vault Security</title>
        <meta
          name="description"
          content="Explore the Sovereign Vault by Aethera: AES-256-GCM encryption, hardened architecture, agentic security, and enterprise-grade data sovereignty."
        />
      </Helmet>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {securityFeatures.map((cat, idx) => (
              <div
                key={idx}
                className="bg-white border border-gray-100 rounded-xl shadow-lg hover:shadow-xl transition-shadow p-8"
              >
                ...
                <div className="flex flex-wrap gap-2">
                  {cat.techs.map((tech) => (
                    <span
                      key={tech}
                      className="px-3 py-1 bg-cyan-100 text-cyan-700 rounded-md text-sm font-medium border border-cyan-200"
                    >
                      {tech}
                    </span>
                  ))}
